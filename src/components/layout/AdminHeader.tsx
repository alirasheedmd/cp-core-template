  ...
  return (
    <nav className="h-[63px] w-full bg-black">
      <div className="mx-auto my-auto flex items-center justify-between gap-x-3 px-5 py-4 lg:gap-x-0 lg:px-16 lg:py-2">
        ...
        <Link
          href={routes.home}
          className="hidden shrink-0 rounded-sm lg:block"
        >
          <Image
            src="/logo.svg"
            alt="logo"
        ...
        <div className="flex gap-x-4">
          {/* Bell */}
          <button className="bg-Orange hover:bg-Orange/80 flex h-8 w-8 items-center justify-center rounded-full transition-colors lg:h-10 lg:w-10">
            <FaBell className="text-white lg:text-lg" />
          </button>
          {/* Profile with Dropdown */}
          <div className="relative" ref={dropdownRef}>
            <button
              className="bg-Orange hover:bg-Orange/80 flex h-8 w-8 items-center justify-center rounded-full transition-colors lg:h-10 lg:w-10"
