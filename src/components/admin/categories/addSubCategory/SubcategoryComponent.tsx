...
export default async function AddSubcategoryComponent({ parentId }: SubcategoryProps) {
  const categories = await getAllCategories()
    return (
      <SubcategoryInfo categories={categories as IWebCategory[]} parentId={parentId} />
  )
}
