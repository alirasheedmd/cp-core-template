    ...
    <div className="max-w-md p-4">
      ...
      <div className="mb-4 mt-8">
        ...
        <input
          ...
          className="w-full rounded border p-2 focus:border-orange-600 focus:outline-hidden focus:ring-0 focus:ring-orange-600 focus:ring-offset-0"
        />
      </div>
      <div className="mb-4">
        <label
      ...
      <button
        ...
        className="mt-4 w-32 text-nowrap rounded-xl bg-white py-2 shadow-md transition-colors hover:text-orange-600"
      >
        Save Settings
      </button>
    </div>
